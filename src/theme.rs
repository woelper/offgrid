...
pub const HAIKU: Skin = Skin {
    ...
    tab_strip_top: Color32::from_rgb(202, 202, 202),
    tab_strip_bottom: Color32::from_rgb(212, 212, 212),
    tab_active_top: Color32::from_rgb(220, 220, 220),
    tab_divider: Color32::from_rgb(186, 186, 186),
    tab_border: Color32::from_rgb(154, 154, 154),
